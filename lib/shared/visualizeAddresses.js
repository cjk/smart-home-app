...
function visualizeAddrValue(props) {
  ...
  switch (addr.func) {
    ...
    default: {
      return (
        <Avatar className={addr.value ? classes.isOn : classes.isOff}>?</Avatar>
      );
    }
  }
}

export default withStyles(addressStyles)(visualizeAddrValue);

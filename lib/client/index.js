...
const config = {
  host:
    'localhost' /* NOTE: Must use IP-address i.e. 192.168.1.28, zircon.local is not available on HOME-LAN! :( */,
...
const ds = {
  ...
  connection: {
    ...
    init() {
      console.info(
        '[homeConnect] Initializing client-connection to deepstream.io...'
      );
      loginPromise().then(
        client => {
          this.client = client;
